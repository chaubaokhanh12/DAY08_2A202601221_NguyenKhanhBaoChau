...
def rerank(
    ...
    Với method="rrf": candidates được coi là 1 ranked list (giữ nguyên thứ tự
    score desc từ retrieval). Để fuse 2 list (dense + sparse), gọi trực tiếp
    rerank_rrf([dense, sparse], top_k).
    """
